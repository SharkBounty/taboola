  ...
  <main class="mx-auto mt-8 grid max-w-[1200px] grid-cols-1 gap-10 px-4 pb-16 lg:grid-cols-[minmax(0,1fr)_300px]">
    ...
    <aside class="min-w-0">
      ...
      <div class="mb-8 border-t-2 border-[#0a2a55] bg-neutral-50 p-4 rounded-b shadow-sm">
        ...
        <p class="text-sm text-neutral-800 mt-1 font-semibold" style="font-family:'Playfair Display',Georgia,serif">"A descarbonização periódica protege as agulhas do injetor e evita a perda de compressão nos cilindros."</p>
